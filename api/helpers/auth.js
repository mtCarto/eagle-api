...
var ISSUER          = process.env.SSO_ISSUER || 'https://dev.oidc.gov.bc.ca/auth/realms/eagle';
var JWKSURI         = process.env.SSO_JWKSURI || 'https://dev.oidc.gov.bc.ca/auth/realms/eagle/protocol/openid-connect/certs';
